...
class Encoder(nn.Module):
    def __init__(self, img_dim, in_channels, out_channels, head_num, mlp_dim, block_num, patch_dim):
        ...
        self.vit = ViT(self.vit_img_dim, out_channels * 4, out_channels * 4, # 8
                       head_num, mlp_dim, block_num, patch_dim=1, classification=False)

        self.conv2 = nn.Conv2d(out_channels * 4, 256, kernel_size=3, stride=1, padding=1) # 512
        self.norm2 = nn.BatchNorm2d(256) # 512
...
class TransUNet(nn.Module):
    def __init__(self, img_dim, in_channels, out_channels, head_num, mlp_dim, block_num, patch_dim, class_num):
        ...
        #self.block3 = ACBlock(4*out_channels,4*out_channels)
